...
public class SimpleBukkitType1_21_R1<P, C> implements PersistentDataType<P, C> {

    private final WrapType<P, C> type;

    public SimpleBukkitType1_21_R1(WrapType<P, C> type) {
        this.type = type;
    }
    ...
    public P toPrimitive(C complex, PersistentDataAdapterContext context) {
        return type.wrapToPrimitive(complex, new SyntaxContext1_21_R1(context));
    }

    @Override
    public C fromPrimitive(P primitive, PersistentDataAdapterContext context) {
        return type.wrapToComplex(primitive, new SyntaxContext1_21_R1(context));
    }
