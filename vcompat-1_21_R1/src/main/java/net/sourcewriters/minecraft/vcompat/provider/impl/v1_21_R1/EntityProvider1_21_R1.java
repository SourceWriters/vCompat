...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R1.utils.EntityConstructors1_21_R1;

public class EntityProvider1_21_R1 extends EntityProvider<VersionControl1_21_R1> {

    private final EnumMap<NmsEntityType, Function<Level, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

    protected EntityProvider1_21_R1(VersionControl1_21_R1 versionControl) {
    ...
    private final Function<Level, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<Level, NmsEntity>) EntityConstructors1_21_R1.class.getField(type.name()).get(null);
