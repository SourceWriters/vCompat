...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R3.data.BukkitContext1_20_R3;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R3.data.BukkitType1_20_R3;
...
public class BukkitConversion1_20_R3 extends BukkitConversion<VersionControl1_20_R3> {

    protected BukkitConversion1_20_R3(VersionControl1_20_R3 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_20_R3(context);
    }

    @Override
    public <P, C> WrapType<P, C> wrap(IDataType<P, C> dataType) {
        return new BukkitType1_20_R3<>(dataType);
    }
