...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R3.utils.EntityConstructors1_20_R3;

public class EntityProvider1_20_R3 extends EntityProvider<VersionControl1_20_R3> {

    private final EnumMap<NmsEntityType, Function<Level, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

    protected EntityProvider1_20_R3(VersionControl1_20_R3 versionControl) {
    ...
    private final Function<Level, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<Level, NmsEntity>) EntityConstructors1_20_R3.class.getField(type.name()).get(null);
