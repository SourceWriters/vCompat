package net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R1.data.hook;
...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R1.data.BukkitContainer1_20_R1;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R1.data.SyntaxContainer1_20_R1;
...
public final class BukkitContainerAdapterHook1_20_R1 {
    ...
    private BukkitContainerAdapterHook1_20_R1() {
        if (HOOK != null) {
    ...
    private void uninjectAll() {
        for (CraftPersistentDataTypeRegistry registry : map.keySet()) {
            ...
            adapters.remove(BukkitContainer1_20_R1.class);
            adapters.remove(SyntaxContainer1_20_R1.class);
    ...
    private <E> E createAdapter(CraftPersistentDataTypeRegistry registry, Class<E> adapterType, Class type) {
        if (Objects.equals(BukkitContainer1_20_R1.class, type)) {
            return (E) buildAdapter(registry, BukkitContainer1_20_R1.class, tag -> fromPrimitiveSyntax(tag));
        }
        if (Objects.equals(SyntaxContainer1_20_R1.class, type)) {
            return (E) buildAdapter(registry, SyntaxContainer1_20_R1.class, tag -> fromPrimitiveBukkit(registry, tag));
        }
    ...
    private BukkitContainer1_20_R1 fromPrimitiveSyntax(CompoundTag data) {
        ...
        return new BukkitContainer1_20_R1(container);
    }

    private SyntaxContainer1_20_R1 fromPrimitiveBukkit(CraftPersistentDataTypeRegistry registry, CompoundTag data) {
