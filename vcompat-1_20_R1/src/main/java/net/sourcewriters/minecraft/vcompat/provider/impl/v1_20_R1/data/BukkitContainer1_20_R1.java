...
public final class BukkitContainer1_20_R1 extends WrappedContainer implements PersistentDataContainer {

    private final IDataContainer container;

    public BukkitContainer1_20_R1(IDataContainer container) {
    ...
    */
    ...
    public <T, Z> boolean has(NamespacedKey key, PersistentDataType<T, Z> type) {
        return has(new BukkitKey1_20_R1(key), WrappedType1_20_R1.wrap(type));
    }

    @Override
    public <T, Z> Z get(NamespacedKey key, PersistentDataType<T, Z> type) {
        return get(new BukkitKey1_20_R1(key), WrappedType1_20_R1.wrap(type));
    }
    ...
    public <T, Z> void set(NamespacedKey key, PersistentDataType<T, Z> type, Z value) {
        set(new BukkitKey1_20_R1(key), value, WrappedType1_20_R1.wrap(type));
    }

    @Override
    public void remove(NamespacedKey key) {
        remove(new BukkitKey1_20_R1(key));
    }

    @Override
    public Set<NamespacedKey> getKeys() {
        return Arrays.stream(container.getKeys()).map(SyntaxKey::new).map(BukkitKey1_20_R1::asBukkit).collect(Collectors.toSet());
    }
    ...
    */
    ...
    @Override
    public BukkitContext1_20_R1 getWrapContext() {
        return new BukkitContext1_20_R1(container.getContext());
    }
