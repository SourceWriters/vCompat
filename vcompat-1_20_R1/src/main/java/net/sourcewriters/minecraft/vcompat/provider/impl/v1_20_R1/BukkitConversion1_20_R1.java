...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R1.data.BukkitContext1_20_R1;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R1.data.BukkitType1_20_R1;
...
public class BukkitConversion1_20_R1 extends BukkitConversion<VersionControl1_20_R1> {

    protected BukkitConversion1_20_R1(VersionControl1_20_R1 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_20_R1(context);
    }
