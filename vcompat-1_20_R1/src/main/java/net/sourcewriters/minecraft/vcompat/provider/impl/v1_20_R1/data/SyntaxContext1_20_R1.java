...
public final class SyntaxContext1_20_R1 extends WrappedContext<PersistentDataAdapterContext> implements PersistentDataAdapterContext {

    private final PersistentDataAdapterContext context;

    public SyntaxContext1_20_R1(PersistentDataAdapterContext context) {
    ...
    @Override
    public SyntaxContainer1_20_R1 newWrapContainer() {
        return new SyntaxContainer1_20_R1(context.newPersistentDataContainer());
    }
