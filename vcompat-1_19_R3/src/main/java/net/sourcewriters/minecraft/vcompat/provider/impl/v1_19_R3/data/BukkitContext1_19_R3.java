...
public final class BukkitContext1_19_R3 extends WrappedContext<IDataAdapterContext> implements PersistentDataAdapterContext {

    private final IDataAdapterContext context;

    public BukkitContext1_19_R3(IDataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_19_R3 newWrapContainer() {
        return new BukkitContainer1_19_R3(context.newContainer());
    }
