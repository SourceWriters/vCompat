...
public final class BukkitContainer1_19_R3 extends WrappedContainer implements PersistentDataContainer {

    private final IDataContainer container;

    public BukkitContainer1_19_R3(IDataContainer container) {
    ...
    */
    ...
    public <T, Z> boolean has(NamespacedKey key, PersistentDataType<T, Z> type) {
        return has(new BukkitKey1_19_R3(key), WrappedType1_19_R3.wrap(type));
    }

    @Override
    public <T, Z> Z get(NamespacedKey key, PersistentDataType<T, Z> type) {
        return get(new BukkitKey1_19_R3(key), WrappedType1_19_R3.wrap(type));
    }
    ...
    public <T, Z> void set(NamespacedKey key, PersistentDataType<T, Z> type, Z value) {
        set(new BukkitKey1_19_R3(key), value, WrappedType1_19_R3.wrap(type));
    }

    @Override
    public void remove(NamespacedKey key) {
        remove(new BukkitKey1_19_R3(key));
    }

    @Override
    public Set<NamespacedKey> getKeys() {
        return Arrays.stream(container.getKeys()).map(SyntaxKey::new).map(BukkitKey1_19_R3::asBukkit).collect(Collectors.toSet());
    }
    ...
    */
    ...
    @Override
    public BukkitContext1_19_R3 getWrapContext() {
        return new BukkitContext1_19_R3(container.getContext());
    }
