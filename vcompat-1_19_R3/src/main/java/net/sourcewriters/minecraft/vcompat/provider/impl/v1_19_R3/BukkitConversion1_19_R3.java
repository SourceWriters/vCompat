...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_19_R3.data.BukkitContext1_19_R3;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_19_R3.data.BukkitType1_19_R3;
...
public class BukkitConversion1_19_R3 extends BukkitConversion<VersionControl1_19_R3> {

    protected BukkitConversion1_19_R3(VersionControl1_19_R3 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_19_R3(context);
    }
