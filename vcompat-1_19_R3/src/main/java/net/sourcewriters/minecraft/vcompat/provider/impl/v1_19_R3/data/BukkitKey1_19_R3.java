...
public final class BukkitKey1_19_R3 extends WrappedKey<NamespacedKey> {

    private final NamespacedKey key;

    public BukkitKey1_19_R3(Plugin plugin, String key) {
        this.key = new NamespacedKey(plugin, key);
    }

    @SuppressWarnings("deprecation")
    public BukkitKey1_19_R3(String name, String key) {
        this.key = new NamespacedKey(name, key);
    }

    public BukkitKey1_19_R3(NamespacedKey key) {
        this.key = key;
    }
    ...
    public static NamespacedKey asBukkit(WrappedKey<?> key) {
        ...
        return new BukkitKey1_19_R3(key.getName(), key.getKey()).getHandle();
    }
