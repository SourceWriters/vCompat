...
public final class SyntaxContext1_19_R3 extends WrappedContext<PersistentDataAdapterContext> implements PersistentDataAdapterContext {

    private final PersistentDataAdapterContext context;

    public SyntaxContext1_19_R3(PersistentDataAdapterContext context) {
    ...
    @Override
    public SyntaxContainer1_19_R3 newWrapContainer() {
        return new SyntaxContainer1_19_R3(context.newPersistentDataContainer());
    }
