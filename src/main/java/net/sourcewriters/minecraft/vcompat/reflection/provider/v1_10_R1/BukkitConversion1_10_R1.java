...
public class BukkitConversion1_10_R1 extends BukkitConversion<VersionControl1_10_R1> {

    protected BukkitConversion1_10_R1(VersionControl1_10_R1 versionControl) {
    ...
    public NbtTag fromMinecraftTag(Object raw) {
        ...
        case DOUBLE:
            return new NbtDouble(((NBTTagDouble) tag).h());
        case STRING:
