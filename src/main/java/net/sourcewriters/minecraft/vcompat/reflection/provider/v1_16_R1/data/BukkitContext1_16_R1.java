...
public final class BukkitContext1_16_R1 extends WrappedContext<DataAdapterContext> implements PersistentDataAdapterContext {

    private final DataAdapterContext context;

    public BukkitContext1_16_R1(DataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_16_R1 newContainer() {
        return new BukkitContainer1_16_R1(context.newDataContainer());
    }
