...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_18_R1.data.hook.BukkitContainerAdapterHook1_18_R1;
...
public class VersionControl1_18_R1 extends VersionControl {
    ...
    private final PacketHandler1_18_R1 packetHandler = new PacketHandler1_18_R1(this);
    ...
    @Override
    public PacketHandler1_18_R1 getPacketHandler() {
