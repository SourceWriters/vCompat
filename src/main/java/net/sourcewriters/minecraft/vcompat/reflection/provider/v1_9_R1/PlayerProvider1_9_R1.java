...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_9_R1.entity.Player1_9_R1;

public class PlayerProvider1_9_R1 extends PlayerProvider<VersionControl1_9_R1> {

    private final DataDistributor<UUID> distributor;

    protected PlayerProvider1_9_R1(VersionControl1_9_R1 versionControl) {
    ...
    protected NmsPlayer createPlayer(Player player) {
        return new Player1_9_R1(player, distributor.get(player.getUniqueId()));
    }
