package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_16_R1;
...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_16_R1.data.BukkitContext1_16_R1;
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_16_R1.data.BukkitType1_16_R1;

public class BukkitConversion1_16_R1 extends BukkitConversion<VersionControl1_16_R1> {

    protected BukkitConversion1_16_R1(VersionControl1_16_R1 versionControl) {
    ...
    public WrappedContext<DataAdapterContext> createContext(DataAdapterContext context) {
        return new BukkitContext1_16_R1(context);
    }

    @Override
    public <P, C> WrapType<P, C> wrap(DataType<P, C> dataType) {
        return new BukkitType1_16_R1<>(dataType);
    }
