...
public class SyntaxType1_16_R3<P0, P1, C0, C1> extends WrappedType1_16_R3<PersistentDataType<P1, C1>, P0, P1, C0, C1>
    implements DataType<P0, C0> {

    private final PersistentDataType<P1, C1> type;

    public SyntaxType1_16_R3(PersistentDataType<P1, C1> type) {
    ...
    */
    ...
    public P0 toPrimitive(DataAdapterContext context, C0 complex) {
        return wrapToPrimitive(complex, new BukkitContext1_16_R3(context));
    }

    @Override
    public C0 fromPrimitive(DataAdapterContext context, P0 primitive) {
        return wrapToComplex(primitive, new BukkitContext1_16_R3(context));
    }
