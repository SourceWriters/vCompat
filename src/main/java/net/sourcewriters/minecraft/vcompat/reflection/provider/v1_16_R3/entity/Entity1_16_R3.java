package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_16_R3.entity;
...
public abstract class Entity1_16_R3<E extends Entity> implements NmsEntity {

    protected final E handle;

    protected final List<UUID> visible = Collections.synchronizedList(new ArrayList<>());

    public Entity1_16_R3(E handle) {
        this.handle = handle;
    }
