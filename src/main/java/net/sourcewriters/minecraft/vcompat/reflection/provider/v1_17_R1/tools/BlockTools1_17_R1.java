package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_17_R1.tools;
...
public class BlockTools1_17_R1 extends BlockTools {
    ...
    public void setHeadTexture(Block block, String texture) {
        ...
        PropertyMap map = entitySkull.e.getProperties();
    ...
    public String getHeadTexture(Block block) {
        ...
        TileEntitySkull entitySkull = (TileEntitySkull) craftEntityStateRef.getFieldValue("tileEntity", block);
        return entitySkull.e.getProperties().get("textures").iterator().next().getValue();
    }
