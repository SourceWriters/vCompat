...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_17_R1.utils.EntityConstructors1_17_R1;
...
public class EntityProvider1_17_R1 extends EntityProvider<VersionControl1_17_R1> {
    ...
    private final Function<World, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<World, NmsEntity>) EntityConstructors1_17_R1.class.getField(type.name()).get(null);
