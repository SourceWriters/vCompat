package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_18_R1.data.hook;
...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_18_R1.data.BukkitContainer1_18_R1;
...
public final class BukkitContainerAdapterHook1_18_R1 {
    ...
    private BukkitContainer1_18_R1 fromPrimitiveSyntax(NBTTagCompound data) {
    ...
    private SyntaxContainer1_18_R1 fromPrimitiveBukkit(CraftPersistentDataTypeRegistry registry, NBTTagCompound data) {
