package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_13_R2;
...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_13_R2.utils.EntityConstructors1_13_R2;

public class EntityProvider1_13_R2 extends EntityProvider<VersionControl1_13_R2> {

    private final EnumMap<NmsEntityType, Function<World, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

    protected EntityProvider1_13_R2(VersionControl1_13_R2 versionControl) {
    ...
    private final Function<World, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<World, NmsEntity>) EntityConstructors1_13_R2.class.getField(type.name()).get(null);
