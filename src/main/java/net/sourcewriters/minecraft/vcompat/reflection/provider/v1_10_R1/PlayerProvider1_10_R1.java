...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_10_R1.entity.Player1_10_R1;

public class PlayerProvider1_10_R1 extends PlayerProvider<VersionControl1_10_R1> {
    ...
    protected NmsPlayer createPlayer(Player player) {
        return new Player1_10_R1(player, distributor.get(player.getUniqueId()));
    }
