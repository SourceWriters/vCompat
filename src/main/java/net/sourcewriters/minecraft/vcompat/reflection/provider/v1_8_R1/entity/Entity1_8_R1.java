package net.sourcewriters.minecraft.vcompat.reflection.provider.v1_8_R1.entity;
...
public abstract class Entity1_8_R1<E extends Entity> implements NmsEntity {

    protected final E handle;

    protected final List<UUID> visible = Collections.synchronizedList(new ArrayList<>());

    public Entity1_8_R1(E handle) {
        this.handle = handle;
    }
