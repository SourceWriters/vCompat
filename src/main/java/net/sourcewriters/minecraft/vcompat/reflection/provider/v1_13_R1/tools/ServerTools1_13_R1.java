...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_13_R1.wrapper.ConsoleReaderWrapper1_13_R1;
import net.sourcewriters.minecraft.vcompat.reflection.tools.ServerTools;

public class ServerTools1_13_R1 extends ServerTools {
    ...
    public ConsoleReaderWrapper1_13_R1 getConsole() {
        return ConsoleReaderWrapper1_13_R1.INSTANCE;
    }
