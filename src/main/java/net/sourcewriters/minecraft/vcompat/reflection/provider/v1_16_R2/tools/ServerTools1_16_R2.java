...
import net.sourcewriters.minecraft.vcompat.reflection.provider.v1_16_R2.wrapper.ConsoleReaderWrapper1_16_R2;
import net.sourcewriters.minecraft.vcompat.reflection.tools.ServerTools;

public class ServerTools1_16_R2 extends ServerTools {
    ...
    public ConsoleReaderWrapper1_16_R2 getConsole() {
        return ConsoleReaderWrapper1_16_R2.INSTANCE;
    }
