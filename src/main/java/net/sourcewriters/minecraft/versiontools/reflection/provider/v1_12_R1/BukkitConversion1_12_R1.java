...
public class BukkitConversion1_12_R1 extends BukkitConversion<VersionControl1_12_R1> {

	protected BukkitConversion1_12_R1(VersionControl1_12_R1 versionControl) {
	...
	public NbtTag fromMinecraftTag(Object raw) {
		...
		case LONG_ARRAY:
			return new NbtLongArray((long[]) ReflectionProvider.DEFAULT.getReflect("nmsNBTTagLongArray").getFieldValue("value", ((NBTTagLongArray) tag).c()));
		case LIST:
