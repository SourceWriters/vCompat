...
import net.minecraft.server.v1_8_R1.BiomeManager;
import net.minecraft.server.v1_8_R1.EntityPlayer;
import net.minecraft.server.v1_8_R1.EnumItemSlot;
import net.minecraft.server.v1_8_R1.IChatBaseComponent;
import net.minecraft.server.v1_8_R1.ItemStack;
import net.minecraft.server.v1_8_R1.MathHelper;
import net.minecraft.server.v1_8_R1.PacketPlayInClientCommand;
import net.minecraft.server.v1_8_R1.PacketPlayInClientCommand.EnumClientCommand;
...
import net.minecraft.server.v1_8_R1.PacketPlayOutPlayerInfo.EnumPlayerInfoAction;
...
import net.minecraft.server.v1_8_R1.PacketPlayOutTitle.EnumTitleAction;
...
public class Player1_8_R1 extends EntityLiving1_8_R1<EntityPlayer> implements NmsPlayer {
	...
	public Player1_8_R1(Player player) {
