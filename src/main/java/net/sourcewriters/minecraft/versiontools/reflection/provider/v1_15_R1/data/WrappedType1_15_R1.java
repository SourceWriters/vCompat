...
public abstract class WrappedType1_15_R1<H, P0, P1, C0, C1> implements WrapType<P0, C0> {
     ...
     public C0 toComplexWrapped(C1 complex) {
          ...
          case 2:
               return (C0) Arrays.stream((PersistentDataContainer[]) complex).map(SyntaxContainer1_15_R1::new)
                    .toArray(IDataContainer[]::new);
          case 3:
               return (C0) new BukkitContainer1_15_R1((IDataContainer) complex);
          case 4:
               return (C0) Arrays.stream((IDataContainer[]) complex).map(BukkitContainer1_15_R1::new)
                    .toArray(PersistentDataContainer[]::new);
          default:
               return (C0) complex;
          }
     ...
     public C1 toComplexOriginal(C0 complex) {
          ...
          case 2:
               return (C1) Arrays.stream((IDataContainer[]) complex).map(BukkitContainer1_15_R1::new)
                    .toArray(PersistentDataContainer[]::new);
          case 3:
               return (C1) new SyntaxContainer1_15_R1((PersistentDataContainer) complex);
          case 4:
               return (C1) Arrays.stream((PersistentDataContainer[]) complex).map(SyntaxContainer1_15_R1::new)
                    .toArray(IDataContainer[]::new);
          default:
               return (C1) complex;
          }
