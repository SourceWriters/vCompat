...
public class Player1_14_R1 extends EntityLiving1_14_R1<EntityPlayer> implements NmsPlayer<PersistentDataContainer> {
	...
	private final PersistentDataAdapter1_14_R1 dataAdapter;

	public Player1_14_R1(Player player) {
		super(((CraftPlayer) player).getHandle());
		dataAdapter = new PersistentDataAdapter1_14_R1(getBukkitPlayer().getPersistentDataContainer());
		update(false);
	}
	...
	@Override
	public PersistentDataAdapter1_14_R1 getDataAdapter() {
		return dataAdapter;
	}
