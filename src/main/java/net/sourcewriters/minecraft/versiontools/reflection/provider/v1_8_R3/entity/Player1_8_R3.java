...
import net.minecraft.server.v1_8_R3.BiomeManager;
import net.minecraft.server.v1_8_R3.EntityPlayer;
import net.minecraft.server.v1_8_R3.EnumItemSlot;
...
public class Player1_8_R3 extends EntityLiving1_8_R3<EntityPlayer> implements NmsPlayer {

	private String realName;

	public Player1_8_R3(Player player) {
