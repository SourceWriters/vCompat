...
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_16_R2.utils.EntityConstructors1_16_R2;

public class EntityProvider1_16_R2 extends EntityProvider<VersionControl1_16_R2> {

	private final EnumMap<NmsEntityType, Function<World, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

	protected EntityProvider1_16_R2(VersionControl1_16_R2 versionControl) {
	...
	private final Function<World, NmsEntity> searchConstructor(NmsEntityType type) {
		try {
			return (Function<World, NmsEntity>) EntityConstructors1_16_R2.class.getField(type.name()).get(null);
