...
public abstract class WrappedType1_14_R1<H, P0, P1, C0, C1> implements WrapType<P0, C0> {
	...
	public P0 toPrimitiveWrapped(P1 primitive) {
		...
		case 2:
			return (P0) Arrays.stream((PersistentDataContainer[]) primitive).map(SyntaxContainer1_14_R1::new).toArray(IDataContainer[]::new);
		case 3:
			return (P0) new BukkitContainer1_14_R1((IDataContainer) primitive);
		case 4:
			return (P0) Arrays.stream((IDataContainer[]) primitive).map(BukkitContainer1_14_R1::new).toArray(PersistentDataContainer[]::new);
		default:
			return (P0) primitive;
		}
	}
	...
	public P1 toPrimitiveOriginal(P0 primitive) {
		...
		case 2:
			return (P1) Arrays.stream((IDataContainer[]) primitive).map(BukkitContainer1_14_R1::new).toArray(PersistentDataContainer[]::new);
		case 3:
			return (P1) new SyntaxContainer1_14_R1((PersistentDataContainer) primitive);
		case 4:
			return (P1) Arrays.stream((PersistentDataContainer[]) primitive).map(SyntaxContainer1_14_R1::new).toArray(IDataContainer[]::new);
		default:
			return (P1) primitive;
		}
	}
