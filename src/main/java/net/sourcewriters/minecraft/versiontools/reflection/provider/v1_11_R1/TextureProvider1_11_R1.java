...
import org.bukkit.craftbukkit.v1_11_R1.block.CraftBlockEntityState;
...
public class TextureProvider1_11_R1 extends TextureProvider<VersionControl1_11_R1> {
	...
	private final AbstractReflect craftMetaSkullRef = new Reflect(
		"org.bukkit.craftbukkit.v1_11_R1.inventory.CraftMetaSkull").searchField("profile", "profile");
