...
public class Player1_15_R1 extends EntityLiving1_15_R1<EntityPlayer> implements NmsPlayer {
	...
	public void fakeRespawn() {
		...
		PacketPlayOutRespawn respawnPacket = new PacketPlayOutRespawn(handle.dimension, handle.world.getSeed(), handle.world.worldData.getType(),
