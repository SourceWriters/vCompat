...
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_8_R3.utils.EntityConstructors1_8_R3;

public class EntityProvider1_8_R3 extends EntityProvider<VersionControl1_8_R3> {

	private final EnumMap<NmsEntityType, Function<World, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

	protected EntityProvider1_8_R3(VersionControl1_8_R3 versionControl) {
	...
	private final Function<World, NmsEntity> searchConstructor(NmsEntityType type) {
		try {
			return (Function<World, NmsEntity>) EntityConstructors1_8_R3.class.getField(type.name()).get(null);
