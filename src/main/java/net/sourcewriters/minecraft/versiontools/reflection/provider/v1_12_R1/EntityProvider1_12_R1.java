...
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_12_R1.utils.EntityConstructors1_12_R1;

public class EntityProvider1_12_R1 extends EntityProvider<VersionControl1_12_R1> {

	private final EnumMap<NmsEntityType, Function<World, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

	protected EntityProvider1_12_R1(VersionControl1_12_R1 versionControl) {
	...
	private final Function<World, NmsEntity> searchConstructor(NmsEntityType type) {
		try {
			return (Function<World, NmsEntity>) EntityConstructors1_12_R1.class.getField(type.name()).get(null);
