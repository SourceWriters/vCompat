...
public class PersistentDataAdapter1_16_R1 extends PersistentDataAdapter<PersistentDataContainer> {

	public PersistentDataAdapter1_16_R1(PersistentDataContainer handle) {
		super(handle);
	}
