...
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_16_R1.data.PersistentDataAdapter1_16_R1;
...
public class Player1_16_R1 extends EntityLiving1_16_R1<EntityPlayer> implements NmsPlayer<PersistentDataContainer> {
	...
	private final PersistentDataAdapter1_16_R1 dataAdapter;

	public Player1_16_R1(Player player) {
		super(((CraftPlayer) player).getHandle());
		dataAdapter = new PersistentDataAdapter1_16_R1(getBukkitPlayer().getPersistentDataContainer());
		update(false);
	}
	...
	@Override
	public PersistentDataAdapter1_16_R1 getDataAdapter() {
		return dataAdapter;
	}
	...
	public void fakeRespawn() {
		...
		PacketPlayOutRespawn respawnPacket = new PacketPlayOutRespawn(world.getTypeKey(), world.getDimensionKey(),
			BiomeManager.a(world.getSeed()), handle.playerInteractManager.getGameMode(),
