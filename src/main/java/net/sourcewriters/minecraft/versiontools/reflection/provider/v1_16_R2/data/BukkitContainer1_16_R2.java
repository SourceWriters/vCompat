...
public final class BukkitContainer1_16_R2 extends WrappedContainer<IDataContainer> implements PersistentDataContainer {

	private final IDataContainer container;

	public BukkitContainer1_16_R2(IDataContainer container) {
	...
	public <T, Z> boolean has(NamespacedKey key, PersistentDataType<T, Z> type) {
		return has(new BukkitKey1_16_R2(key), WrappedType1_16_R2.wrap(type));
	}

	@Override
	public <T, Z> Z get(NamespacedKey key, PersistentDataType<T, Z> type) {
		return get(new BukkitKey1_16_R2(key), WrappedType1_16_R2.wrap(type));
	}
	...
	public <T, Z> void set(NamespacedKey key, PersistentDataType<T, Z> type, Z value) {
		set(new BukkitKey1_16_R2(key), value, WrappedType1_16_R2.wrap(type));
	}

	@Override
	public void remove(NamespacedKey key) {
		remove(new BukkitKey1_16_R2(key));
	}
