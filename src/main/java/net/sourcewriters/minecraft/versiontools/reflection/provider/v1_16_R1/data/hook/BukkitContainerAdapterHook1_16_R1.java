package net.sourcewriters.minecraft.versiontools.reflection.provider.v1_16_R1.data.hook;
...
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_16_R1.data.BukkitContainer1_16_R1;
import net.sourcewriters.minecraft.versiontools.reflection.provider.v1_16_R1.data.SyntaxContainer1_16_R1;

@SuppressWarnings({
    "rawtypes",
    "unchecked"
})
public final class BukkitContainerAdapterHook1_16_R1 {
    ...
    private void uninjectAll() {
        for (CraftPersistentDataTypeRegistry registry : map.keySet()) {
            ...
            adapters.remove(BukkitContainer1_16_R1.class);
            adapters.remove(SyntaxContainer1_16_R1.class);
    ...
    private <E> E createAdapter(CraftPersistentDataTypeRegistry registry, Class<E> adapterType, Class type) {
        if (Objects.equals(BukkitContainer1_16_R1.class, type)) {
            return (E) buildAdapter(registry, BukkitContainer1_16_R1.class, tag -> fromPrimitiveSyntax(tag));
        }
        if (Objects.equals(SyntaxContainer1_16_R1.class, type)) {
            return (E) buildAdapter(registry, SyntaxContainer1_16_R1.class, tag -> fromPrimitiveBukkit(registry, tag));
        }
    ...
    private BukkitContainer1_16_R1 fromPrimitiveSyntax(NBTTagCompound data) {
        ...
        return new BukkitContainer1_16_R1(container);
    }

    private SyntaxContainer1_16_R1 fromPrimitiveBukkit(CraftPersistentDataTypeRegistry registry, NBTTagCompound data) {
