...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R4.data.BukkitContext1_20_R4;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R4.data.BukkitType1_20_R4;
...
public class BukkitConversion1_20_R4 extends BukkitConversion<VersionControl1_20_R4> {
    ...
    protected BukkitConversion1_20_R4(VersionControl1_20_R4 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_20_R4(context);
    }

    @Override
    public <P, C> WrapType<P, C> wrap(IDataType<P, C> dataType) {
        return new BukkitType1_20_R4<>(dataType);
    }
