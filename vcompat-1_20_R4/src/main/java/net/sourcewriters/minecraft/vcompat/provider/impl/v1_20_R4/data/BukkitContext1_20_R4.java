...
public final class BukkitContext1_20_R4 extends WrappedContext<IDataAdapterContext> implements PersistentDataAdapterContext {

    private final IDataAdapterContext context;

    public BukkitContext1_20_R4(IDataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_20_R4 newWrapContainer() {
        return new BukkitContainer1_20_R4(context.newContainer());
    }
