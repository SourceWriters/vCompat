...
public final class BukkitContainer1_20_R4 extends WrappedContainer implements PersistentDataContainer {

    private final IDataContainer container;

    public BukkitContainer1_20_R4(IDataContainer container) {
    ...
    */
    ...
    public <T, Z> boolean has(NamespacedKey key, PersistentDataType<T, Z> type) {
        return has(new BukkitKey1_20_R4(key), WrappedType1_20_R4.wrap(type));
    }

    @Override
    public <T, Z> Z get(NamespacedKey key, PersistentDataType<T, Z> type) {
        return get(new BukkitKey1_20_R4(key), WrappedType1_20_R4.wrap(type));
    }
    ...
    public <T, Z> void set(NamespacedKey key, PersistentDataType<T, Z> type, Z value) {
        set(new BukkitKey1_20_R4(key), value, WrappedType1_20_R4.wrap(type));
    }

    @Override
    public void remove(NamespacedKey key) {
        remove(new BukkitKey1_20_R4(key));
    }

    @Override
    public Set<NamespacedKey> getKeys() {
        return Arrays.stream(container.getKeys()).map(SyntaxKey::new).map(BukkitKey1_20_R4::asBukkit).collect(Collectors.toSet());
    }
    ...
    */
    ...
    @Override
    public BukkitContext1_20_R4 getWrapContext() {
        return new BukkitContext1_20_R4(container.getContext());
    }
