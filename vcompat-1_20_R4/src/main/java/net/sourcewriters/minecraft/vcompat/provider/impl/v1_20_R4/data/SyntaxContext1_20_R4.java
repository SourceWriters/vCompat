...
public final class SyntaxContext1_20_R4 extends WrappedContext<PersistentDataAdapterContext> implements PersistentDataAdapterContext {

    private final PersistentDataAdapterContext context;

    public SyntaxContext1_20_R4(PersistentDataAdapterContext context) {
    ...
    @Override
    public SyntaxContainer1_20_R4 newWrapContainer() {
        return new SyntaxContainer1_20_R4(context.newPersistentDataContainer());
    }
