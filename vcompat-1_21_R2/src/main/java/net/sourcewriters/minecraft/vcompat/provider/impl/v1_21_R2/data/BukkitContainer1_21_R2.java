...
public final class BukkitContainer1_21_R2 extends WrappedContainer implements PersistentDataContainer {

    private final IDataContainer container;

    public BukkitContainer1_21_R2(IDataContainer container) {
    ...
    */
    ...
    public <T, Z> boolean has(NamespacedKey key, PersistentDataType<T, Z> type) {
        return has(new BukkitKey1_21_R2(key), WrappedType1_21_R2.wrap(type));
    }

    @Override
    public <T, Z> Z get(NamespacedKey key, PersistentDataType<T, Z> type) {
        return get(new BukkitKey1_21_R2(key), WrappedType1_21_R2.wrap(type));
    }
    ...
    public <T, Z> void set(NamespacedKey key, PersistentDataType<T, Z> type, Z value) {
        set(new BukkitKey1_21_R2(key), value, WrappedType1_21_R2.wrap(type));
    }

    @Override
    public void remove(NamespacedKey key) {
        remove(new BukkitKey1_21_R2(key));
    }

    @Override
    public Set<NamespacedKey> getKeys() {
        return Arrays.stream(container.getKeys()).map(SyntaxKey::new).map(BukkitKey1_21_R2::asBukkit).collect(Collectors.toSet());
    }
    ...
    */
    ...
    @Override
    public BukkitContext1_21_R2 getWrapContext() {
        return new BukkitContext1_21_R2(container.getContext());
    }
