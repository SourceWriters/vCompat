...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R2.data.BukkitContext1_21_R2;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R2.data.BukkitType1_21_R2;
...
public class BukkitConversion1_21_R2 extends BukkitConversion<VersionControl1_21_R2> {
    
    private final Frozen registry = ((CraftServer) Bukkit.getServer()).getServer().registryAccess();

    protected BukkitConversion1_21_R2(VersionControl1_21_R2 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_21_R2(context);
    }

    @Override
    public <P, C> WrapType<P, C> wrap(IDataType<P, C> dataType) {
        return new BukkitType1_21_R2<>(dataType);
    }
