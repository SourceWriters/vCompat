...
public final class BukkitContext1_21_R2 extends WrappedContext<IDataAdapterContext> implements PersistentDataAdapterContext {

    private final IDataAdapterContext context;

    public BukkitContext1_21_R2(IDataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_21_R2 newWrapContainer() {
        return new BukkitContainer1_21_R2(context.newContainer());
    }
