package net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R2.data.hook;
...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R2.data.BukkitContainer1_21_R2;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R2.data.SyntaxContainer1_21_R2;
...
public final class BukkitContainerAdapterHook1_21_R2 {

    private static final BukkitContainerAdapterHook1_21_R2 HOOK = new BukkitContainerAdapterHook1_21_R2();

    private final ClassLookup registryRef;
    private final ClassLookup entityRef;

    private BukkitContainerAdapterHook1_21_R2() {
        if (HOOK != null) {
    ...
    private void uninjectAll() {
        for (CraftPersistentDataTypeRegistry registry : map.keySet()) {
            ...
            adapters.remove(BukkitContainer1_21_R2.class);
            adapters.remove(SyntaxContainer1_21_R2.class);
    ...
    private <E> E createAdapter(CraftPersistentDataTypeRegistry registry, Class<E> adapterType, Class type) {
        if (Objects.equals(BukkitContainer1_21_R2.class, type)) {
            return (E) buildAdapter(registry, BukkitContainer1_21_R2.class, tag -> fromPrimitiveSyntax(tag));
        }
        if (Objects.equals(SyntaxContainer1_21_R2.class, type)) {
            return (E) buildAdapter(registry, SyntaxContainer1_21_R2.class, tag -> fromPrimitiveBukkit(registry, tag));
        }
    ...
    private BukkitContainer1_21_R2 fromPrimitiveSyntax(CompoundTag data) {
        ...
        return new BukkitContainer1_21_R2(container);
    }

    private SyntaxContainer1_21_R2 fromPrimitiveBukkit(CraftPersistentDataTypeRegistry registry, CompoundTag data) {
        CraftPersistentDataContainer container = new CraftPersistentDataContainer(registry);
        container.putAll(data);
        return new SyntaxContainer1_21_R2(container);
    }
