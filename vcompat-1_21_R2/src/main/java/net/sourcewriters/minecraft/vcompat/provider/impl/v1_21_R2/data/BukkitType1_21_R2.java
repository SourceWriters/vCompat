...
public class BukkitType1_21_R2<P0, P1, C0, C1> extends WrappedType1_21_R2<IDataType<P1, C1>, P0, P1, C0, C1>
    implements PersistentDataType<P0, C0> {

    private final IDataType<P1, C1> type;

    public BukkitType1_21_R2(IDataType<P1, C1> type) {
    ...
    */
    ...
    public P0 toPrimitive(C0 complex, PersistentDataAdapterContext context) {
        return wrapToPrimitive(complex, new SyntaxContext1_21_R2(context));
    }

    @Override
    public C0 fromPrimitive(P0 primitive, PersistentDataAdapterContext context) {
        return wrapToComplex(primitive, new SyntaxContext1_21_R2(context));
    }
