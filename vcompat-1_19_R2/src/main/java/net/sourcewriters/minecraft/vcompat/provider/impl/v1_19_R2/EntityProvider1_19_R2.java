...
public class EntityProvider1_19_R2 extends EntityProvider<VersionControl1_19_R2> {

    private final EnumMap<NmsEntityType, Function<Level, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

    protected EntityProvider1_19_R2(VersionControl1_19_R2 versionControl) {
    ...
    private final Function<Level, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<Level, NmsEntity>) EntityConstructors1_19_R2.class.getField(type.name()).get(null);
