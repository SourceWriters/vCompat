...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_19_R2.data.BukkitContext1_19_R2;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_19_R2.data.BukkitType1_19_R2;
...
public class BukkitConversion1_19_R2 extends BukkitConversion<VersionControl1_19_R2> {

    protected BukkitConversion1_19_R2(VersionControl1_19_R2 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_19_R2(context);
    }
