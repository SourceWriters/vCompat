...
public final class BukkitContext1_16_R3 extends WrappedContext<IDataAdapterContext> implements PersistentDataAdapterContext {

    private final IDataAdapterContext context;

    public BukkitContext1_16_R3(IDataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_16_R3 newWrapContainer() {
        return new BukkitContainer1_16_R3(context.newContainer());
    }
