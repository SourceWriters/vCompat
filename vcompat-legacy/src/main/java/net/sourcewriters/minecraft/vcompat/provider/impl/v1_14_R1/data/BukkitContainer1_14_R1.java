package net.sourcewriters.minecraft.vcompat.provider.impl.v1_14_R1.data;
...
public final class BukkitContainer1_14_R1 extends WrappedContainer implements PersistentDataContainer {
    ...
    */
    ...
    public Set<NamespacedKey> getKeys() {
        return Arrays.stream(container.getKeys()).map(SyntaxKey::new).map(BukkitKey1_14_R1::asBukkit).collect(Collectors.toSet());
    }
    ...
    */
    ...
    @Override
    public BukkitContext1_14_R1 getWrapContext() {
        return new BukkitContext1_14_R1(container.getContext());
    }
