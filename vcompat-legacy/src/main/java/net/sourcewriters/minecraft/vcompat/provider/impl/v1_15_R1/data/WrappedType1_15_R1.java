...
public abstract class WrappedType1_15_R1<H, P0, P1, C0, C1> implements WrapType<P0, C0> {
    ...
    public P0 toPrimitiveWrapped(P1 primitive) {
        ...
        case 2:
            return (P0) Arrays.stream((PersistentDataContainer[]) primitive).map(SyntaxContainer1_15_R1::new)
                .toArray(SyntaxContainer1_15_R1[]::new);
        case 3:
            return (P0) new BukkitContainer1_15_R1((IDataContainer) primitive);
        case 4:
            return (P0) Arrays.stream((IDataContainer[]) primitive).map(BukkitContainer1_15_R1::new)
                .toArray(BukkitContainer1_15_R1[]::new);
        default:
            return (P0) primitive;
        }
    }
    ...
    public C0 toComplexWrapped(C1 complex) {
        ...
        case 2:
            return (C0) Arrays.stream((PersistentDataContainer[]) complex).map(SyntaxContainer1_15_R1::new).toArray(SyntaxContainer1_15_R1[]::new);
        case 3:
            return (C0) new BukkitContainer1_15_R1((IDataContainer) complex);
        case 4:
            return (C0) Arrays.stream((IDataContainer[]) complex).map(BukkitContainer1_15_R1::new).toArray(BukkitContainer1_15_R1[]::new);
        default:
            return (C0) complex;
        }
    }
    ...
    public P1 toPrimitiveOriginal(P0 primitive) {
        ...
        case 2:
            return (P1) Arrays.stream((IDataContainer[]) primitive).map(BukkitContainer1_15_R1::new)
                .toArray(BukkitContainer1_15_R1[]::new);
        case 3:
            return (P1) new SyntaxContainer1_15_R1((PersistentDataContainer) primitive);
        case 4:
            return (P1) Arrays.stream((PersistentDataContainer[]) primitive).map(SyntaxContainer1_15_R1::new)
                .toArray(SyntaxContainer1_15_R1[]::new);
        default:
            return (P1) primitive;
        }
    ...
    public C1 toComplexOriginal(C0 complex) {
        ...
        case 2:
            return (C1) Arrays.stream((IDataContainer[]) complex).map(BukkitContainer1_15_R1::new).toArray(BukkitContainer1_15_R1[]::new);
        case 3:
            return (C1) new SyntaxContainer1_15_R1((PersistentDataContainer) complex);
        case 4:
            return (C1) Arrays.stream((PersistentDataContainer[]) complex).map(SyntaxContainer1_15_R1::new).toArray(SyntaxContainer1_15_R1[]::new);
        default:
            return (C1) complex;
        }
    }
    ...
    protected static Class<?> internalWrap(Class<?> clazz, int state) {
        switch (state) {
        case 1:
            return SyntaxContainer1_15_R1.class;
        case 2:
            return SyntaxContainer1_15_R1[].class;
        case 3:
            return BukkitContainer1_15_R1.class;
        case 4:
            return BukkitContainer1_15_R1[].class;
        default:
            return clazz;
    ...
    public static <A, B, C, D> BukkitType1_15_R1<C, A, D, B> wrap(IDataType<A, B> type) {
        return new BukkitType1_15_R1<>(type);
    }

    public static <A, B, C, D> SyntaxType1_15_R1<C, A, D, B> wrap(PersistentDataType<A, B> type) {
