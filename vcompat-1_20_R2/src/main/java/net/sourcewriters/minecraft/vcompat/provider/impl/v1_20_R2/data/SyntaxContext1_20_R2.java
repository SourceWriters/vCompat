...
public final class SyntaxContext1_20_R2 extends WrappedContext<PersistentDataAdapterContext> implements PersistentDataAdapterContext {

    private final PersistentDataAdapterContext context;

    public SyntaxContext1_20_R2(PersistentDataAdapterContext context) {
    ...
    @Override
    public SyntaxContainer1_20_R2 newWrapContainer() {
        return new SyntaxContainer1_20_R2(context.newPersistentDataContainer());
    }
