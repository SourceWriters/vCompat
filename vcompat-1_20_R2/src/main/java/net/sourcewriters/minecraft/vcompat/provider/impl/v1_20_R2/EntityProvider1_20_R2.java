...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R2.utils.EntityConstructors1_20_R2;

public class EntityProvider1_20_R2 extends EntityProvider<VersionControl1_20_R2> {

    private final EnumMap<NmsEntityType, Function<Level, NmsEntity>> entityMap = new EnumMap<>(NmsEntityType.class);

    protected EntityProvider1_20_R2(VersionControl1_20_R2 versionControl) {
    ...
    private final Function<Level, NmsEntity> searchConstructor(NmsEntityType type) {
        try {
            return (Function<Level, NmsEntity>) EntityConstructors1_20_R2.class.getField(type.name()).get(null);
