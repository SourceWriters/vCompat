...
public class SimpleBukkitType1_20_R2<P, C> implements PersistentDataType<P, C> {

    private final WrapType<P, C> type;

    public SimpleBukkitType1_20_R2(WrapType<P, C> type) {
        this.type = type;
    }
    ...
    public P toPrimitive(C complex, PersistentDataAdapterContext context) {
        return type.wrapToPrimitive(complex, new SyntaxContext1_20_R2(context));
    }

    @Override
    public C fromPrimitive(P primitive, PersistentDataAdapterContext context) {
        return type.wrapToComplex(primitive, new SyntaxContext1_20_R2(context));
    }
