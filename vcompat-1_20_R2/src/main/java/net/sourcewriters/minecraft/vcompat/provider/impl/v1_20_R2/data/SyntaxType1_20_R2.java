...
public class SyntaxType1_20_R2<P0, P1, C0, C1> extends WrappedType1_20_R2<PersistentDataType<P1, C1>, P0, P1, C0, C1>
    implements IDataType<P0, C0> {

    private final PersistentDataType<P1, C1> type;

    public SyntaxType1_20_R2(PersistentDataType<P1, C1> type) {
    ...
    */
    ...
    public P0 toPrimitive(IDataAdapterContext context, C0 complex) {
        return wrapToPrimitive(complex, new BukkitContext1_20_R2(context));
    }

    @Override
    public C0 fromPrimitive(IDataAdapterContext context, P0 primitive) {
        return wrapToComplex(primitive, new BukkitContext1_20_R2(context));
    }
