...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R2.data.BukkitContext1_20_R2;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_20_R2.data.BukkitType1_20_R2;
...
public class BukkitConversion1_20_R2 extends BukkitConversion<VersionControl1_20_R2> {

    protected BukkitConversion1_20_R2(VersionControl1_20_R2 versionControl) {
    ...
    public WrappedContext<IDataAdapterContext> createContext(IDataAdapterContext context) {
        return new BukkitContext1_20_R2(context);
    }

    @Override
    public <P, C> WrapType<P, C> wrap(IDataType<P, C> dataType) {
        return new BukkitType1_20_R2<>(dataType);
    }
