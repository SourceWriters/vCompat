...
public final class BukkitKey1_17_R1 extends WrappedKey<NamespacedKey> {

    private final NamespacedKey key;

    public BukkitKey1_17_R1(Plugin plugin, String key) {
        this.key = new NamespacedKey(plugin, key);
    }

    @SuppressWarnings("deprecation")
    public BukkitKey1_17_R1(String name, String key) {
        this.key = new NamespacedKey(name, key);
    }

    public BukkitKey1_17_R1(NamespacedKey key) {
        this.key = key;
    }
    ...
    public static NamespacedKey asBukkit(WrappedKey<?> key) {
        ...
        return new BukkitKey1_17_R1(key.getName(), key.getKey()).getHandle();
    }
