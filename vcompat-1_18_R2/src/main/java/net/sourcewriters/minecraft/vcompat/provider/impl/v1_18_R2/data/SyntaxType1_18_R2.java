...
public class SyntaxType1_18_R2<P0, P1, C0, C1> extends WrappedType1_18_R2<PersistentDataType<P1, C1>, P0, P1, C0, C1>
    implements IDataType<P0, C0> {

    private final PersistentDataType<P1, C1> type;

    public SyntaxType1_18_R2(PersistentDataType<P1, C1> type) {
