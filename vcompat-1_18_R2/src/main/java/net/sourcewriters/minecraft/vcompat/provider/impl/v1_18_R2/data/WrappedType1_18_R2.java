...
public abstract class WrappedType1_18_R2<H, P0, P1, C0, C1> implements WrapType<P0, C0> {
    ...
    protected WrappedType1_18_R2(Class<P1> primitive, Class<C1> complex) {
        this.primitiveWrap = WrappedType1_18_R2.internalState(primitive);
        this.complexWrap = WrappedType1_18_R2.internalState(complex);
        this.primitiveType = (Class<P0>) WrappedType1_18_R2.internalWrap(primitive, primitiveWrap);
        this.complexType = (Class<C0>) WrappedType1_18_R2.internalWrap(complex, complexWrap);
    }
    ...
    public static <A, B, C, D> BukkitType1_18_R2<C, A, D, B> wrap(IDataType<A, B> type) {
        return new BukkitType1_18_R2<>(type);
    }

    public static <A, B, C, D> SyntaxType1_18_R2<C, A, D, B> wrap(PersistentDataType<A, B> type) {
