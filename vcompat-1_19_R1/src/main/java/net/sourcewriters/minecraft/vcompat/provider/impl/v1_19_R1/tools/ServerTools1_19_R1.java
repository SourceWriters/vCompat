...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_19_R1.wrapper.ConsoleReaderWrapper1_19_R1;
import net.sourcewriters.minecraft.vcompat.provider.tools.ServerTools;

public class ServerTools1_19_R1 extends ServerTools {
    ...
    public ConsoleReaderWrapper1_19_R1 getConsole() {
        return ConsoleReaderWrapper1_19_R1.INSTANCE;
    }
