...
public final class BukkitContext1_19_R1 extends WrappedContext<IDataAdapterContext> implements PersistentDataAdapterContext {

    private final IDataAdapterContext context;

    public BukkitContext1_19_R1(IDataAdapterContext context) {
    ...
    @Override
    public BukkitContainer1_19_R1 newWrapContainer() {
        return new BukkitContainer1_19_R1(context.newContainer());
    }
