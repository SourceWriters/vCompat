package net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R3.data.hook;
...
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R3.data.BukkitContainer1_21_R3;
import net.sourcewriters.minecraft.vcompat.provider.impl.v1_21_R3.data.SyntaxContainer1_21_R3;
...
public final class BukkitContainerAdapterHook1_21_R3 {

    private static final BukkitContainerAdapterHook1_21_R3 HOOK = new BukkitContainerAdapterHook1_21_R3();

    private final ClassLookup registryRef;
    private final ClassLookup entityRef;

    private BukkitContainerAdapterHook1_21_R3() {
        if (HOOK != null) {
    ...
    private void uninjectAll() {
        for (CraftPersistentDataTypeRegistry registry : map.keySet()) {
            ...
            adapters.remove(BukkitContainer1_21_R3.class);
            adapters.remove(SyntaxContainer1_21_R3.class);
    ...
    private <E> E createAdapter(CraftPersistentDataTypeRegistry registry, Class<E> adapterType, Class type) {
        if (Objects.equals(BukkitContainer1_21_R3.class, type)) {
            return (E) buildAdapter(registry, BukkitContainer1_21_R3.class, tag -> fromPrimitiveSyntax(tag));
        }
        if (Objects.equals(SyntaxContainer1_21_R3.class, type)) {
            return (E) buildAdapter(registry, SyntaxContainer1_21_R3.class, tag -> fromPrimitiveBukkit(registry, tag));
        }
    ...
    private BukkitContainer1_21_R3 fromPrimitiveSyntax(CompoundTag data) {
        ...
        return new BukkitContainer1_21_R3(container);
    }

    private SyntaxContainer1_21_R3 fromPrimitiveBukkit(CraftPersistentDataTypeRegistry registry, CompoundTag data) {
        CraftPersistentDataContainer container = new CraftPersistentDataContainer(registry);
        container.putAll(data);
        return new SyntaxContainer1_21_R3(container);
    }
